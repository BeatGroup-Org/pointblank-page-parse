    ...
    <>
      ...
      <main>
        ...
        <section className="bg-background">
          <div
            ref={infoRef}
            className="fade-in-section py-12 md:py-16 container mx-auto px-6"
          >
        ...
        {(evento.descrizioneEstesa || evento.descrizione) && (
          <section className="bg-secondary">
            <div
              ref={descRef}
              className="fade-in-section py-16 md:py-24 container mx-auto px-6 max-w-3xl"
            >
        ...
        <section className="bg-secondary">
          <div
            ref={ctaRef}
            className="fade-in-section py-16 md:py-20 container mx-auto px-6 max-w-3xl"
          >
