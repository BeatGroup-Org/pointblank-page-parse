        ...
        <section className="bg-background">
          <div ref={famiglieRef} className="fade-in-section py-20 md:py-28 container mx-auto px-6 max-w-5xl">
            <div className="grid md:grid-cols-[1fr_2fr] gap-10 md:gap-14 items-start">
              ...
              <div className="w-full aspect-[3/4] rounded-2xl overflow-hidden">
                <img
                  src="https://apsvfcqshxmqigyihehe.supabase.co/storage/v1/object/sign/Customers/Mousike/Ma%20che%20musica%20maestro/MaCheMusicaMaestro_Famiglie.jpg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV9jODgwZDk1Ny0wYzcxLTRjZmUtOWQwOS1iNDlmMjVhNjc4MmUiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJDdXN0b21lcnMvTW91c2lrZS9NYSBjaGUgbXVzaWNhIG1hZXN0cm8vTWFDaGVNdXNpY2FNYWVzdHJvX0ZhbWlnbGllLmpwZyIsImlhdCI6MTc3NDQ1ODAyMiwiZXhwIjoyNjM4NDU4MDIyfQ.XyceWAzP9h9zsiXecqciF6awcUFlsh505BYPPgP13B0"
                  alt="Le famiglie dentro il progetto - Ma Che Musica Maestro!"
                  className="w-full h-full object-cover"
                  loading="lazy"
                />
              </div>
