      ...
      <div ref={ref} className="fade-in-section container mx-auto px-6 max-w-4xl">
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-card border border-border rounded-lg p-10 text-center">
            <h3 className="text-2xl font-bold mb-3 uppercase">VUOI INIZIARE UN PERCORSO MUSICALE?</h3>
          ...
          <div className="bg-card border border-border rounded-lg p-10 text-center">
            <h3 className="text-2xl font-bold mb-3 uppercase">SEI UNA SCUOLA O UN ENTE?</h3>
